...
- **Cualquier socio puede**: marcar **su propia** cuota (el administrador
  puede marcar la de cualquiera), reservar la peña, apuntarse a tareas de
  "Encargados", editar su propio perfil (incluido su nombre), y ver todo
  lo demás en modo lectura (socios y caja son de solo lectura para el
  resto).
...
- **Alertas** (pestaña Resumen): avisa si algún socio activo no ha
  pagado la cuota del mes pasados 5 días, y muestra un pequeño resumen de
...
> ⚠️ **Privacidad**: las fotos de perfil (`static/avatars/`) se guardan
